...
!function (e, t) {
  ...
  return function (e) {
    ...
    var a = n(0),
      ...
      bind: function bind(e, t, n) {
        e["@clickoutside"] = function (a) {
          var i = a.target,
              s = n && n.context && n.context.popupElm;
          !r || !i || e.contains(i) || e.contains(r) || s && (s.contains(r) || s.contains(i)) || !t.expression || !n.context[t.expression] || t.value();
        }, document.addEventListener("mousedown", s), document.addEventListener("mouseup", e["@clickoutside"]);
      },
      unbind: function unbind(e) {
        document.removeEventListener("mousedown", s), document.removeEventListener("mouseup", e["@clickoutside"]);
      }
    };
    ...
    var f = {
      ...
      methods: {
        t: function t(e) {
          ...
          for (var a = t && t.language || g, i = e.split("."), r = a, s = void 0, o = 0, l = i.length; o < l; o++) {
      ...
      methods: {
        ...
        getCellTitle: function getCellTitle(e) {
          var t = e.year,
              n = e.month,
              a = e.day;
          return p(new Date(t, n, a), this.dateFormat);
        }
      },
    ...
    var A = Y({
      ...
      components: {
        ...
        PanelTime: {
          ...
          methods: {
            ...
            getTimePickerOptions: function getTimePickerOptions() {
              ...
              var n = d(t.start),
                  a = d(t.end),
                  i = d(t.step);
              if (n && a && i) for (var r = n.minutes + 60 * n.hours, s = a.minutes + 60 * a.hours, o = i.minutes + 60 * i.hours, l = Math.floor((s - r) / o), u = 0; u <= l; u++) {
                var c = r + u * o,
                    p = {
                  hours: Math.floor(c / 60),
                  minutes: c % 60
                };
                e.push({
                  value: p,
                  label: h.apply(void 0, [p].concat(k(this.timeType)))
                });
              }
              return e;
            }
          ...
          render: function render(e) {
            ...
            var r = this.minuteStep || 1,
                s = parseInt(60 / r),
                o = {
              hours: Array.apply(null, {
                length: 24
              }).map(function (e, t) {
                return t;
              }),
              minutes: Array.apply(null, {
                length: s
              }).map(function (e, t) {
                return t * r;
              }),
              seconds: 0 === this.minuteStep ? Array.apply(null, {
                length: 60
              }).map(function (e, t) {
                return t;
              }) : []
            };
            this.timeSelectOptions && "object" === S(this.timeSelectOptions) && (o = T({}, o, this.timeSelectOptions));
            var l = [o.hours.map(function (i) {
              var r = new Date(n).setHours(i);
              return e("li", {
                "class": {
                  cell: !0,
                  actived: i === t.currentHours,
                  disabled: a && a(r)
                },
                on: {
                  click: t.selectTime.bind(t, r)
                }
              }, [t.stringifyText(i)]);
            }), o.minutes.map(function (i) {
              var r = new Date(n).setMinutes(i);
              return e("li", {
                "class": {
                  cell: !0,
                  actived: i === t.currentMinutes,
                  disabled: a && a(r)
                },
                on: {
                  click: t.selectTime.bind(t, r)
            ...
            }), o.seconds.map(function (i) {
              var r = new Date(n).setSeconds(i);
              return e("li", {
                "class": {
                  cell: !0,
                  actived: i === t.currentSeconds,
                  disabled: a && a(r)
                },
                on: {
                  click: t.selectTime.bind(t, r)
      ...
      computed: {
        ...
        timeHeader: function timeHeader() {
          return "time" === this.type ? this.$parent.format : this.value && p(this.value, this.dateFormat);
        },
      ...
      methods: {
        ...
        getNow: function getNow(e) {
          return e ? new Date(e) : this.defaultValue && c(this.defaultValue) ? new Date(this.defaultValue) : new Date();
        },
        ...
        selectDate: function selectDate(e) {
          if ("datetime" === this.type) {
            var t = new Date(e);
            return u(this.value) && t.setHours(this.value.getHours(), this.value.getMinutes(), this.value.getSeconds()), this.isDisabledTime(t) && (t.setHours(0, 0, 0, 0), this.notBefore && t.getTime() < new Date(this.notBefore).getTime() && (t = new Date(this.notBefore)), this.startAt && t.getTime() < new Date(this.startAt).getTime() && (t = new Date(this.startAt))), this.selectTime(t), void this.showPanelTime();
          }
        ...
        selectYear: function selectYear(e) {
          ...
          this.dispatch("DatePicker", "select-year", [e, this.index]), this.showPanelMonth();
        },
        selectMonth: function selectMonth(e) {
          if (this.changeCalendarMonth(e), "month" === this.type.toLowerCase()) return this.selectDate(new Date(this.now));
          this.dispatch("DatePicker", "select-month", [e, this.index]), this.showPanelDate();
        },
        selectTime: function selectTime(e) {
      ...
      return n("div", {
        ...
        attrs: {
          ...
          "time-select-options": e.timeSelectOptions,
          value: e.value,
      ...
      props: {
        ...
        valueType: {
          "default": "date",
          validator: function validator(e) {
            return -1 !== ["timestamp", "format", "date"].indexOf(e) || l(e);
          }
        },
        placeholder: {
          type: String,
      ...
      computed: {
        transform: function transform() {
          ...
          return l(e) ? C({}, f.date, e) : "format" === e ? {
            value2date: this.parse.bind(this),
            date2value: this.stringify.bind(this)
          } : f[e] || f.date;
        },
        language: function language() {
          return l(this.lang) ? C({}, m.en, this.lang) : m[this.lang] || m.en;
        },
        ...
        innerPopupStyle: function innerPopupStyle() {
          return C({}, this.position, this.popupStyle);
        }
      },
      ...
      methods: {
        ...
        stringify: function stringify(e) {
          return l(this.format) && "function" == typeof this.format.stringify ? this.format.stringify(e) : p(e, this.format);
        },
        parse: function parse(e) {
          return l(this.format) && "function" == typeof this.format.parse ? this.format.parse(e) : function (e, t) {
            try {
              return i.a.parse(e, t) || null;
            } catch (e) {
              return null;
            }
          }(e, this.format);
        ...
        isValidValue: function isValidValue(e) {
          return c((0, this.transform.value2date)(e));
        },
        ...
        dateEqual: function dateEqual(e, t) {
          return u(e) && u(t) && e.getTime() === t.getTime();
        },
        ...
        selectRange: function selectRange(e) {
          "function" == typeof e.onClick ? !1 !== e.onClick(this) && this.closePopup() : (this.currentValue = [new Date(e.start), new Date(e.end)], this.updateDate(!0), this.closePopup());
        },
        ...
        confirmDate: function confirmDate() {
          var e;
          (this.range ? (e = this.currentValue, Array.isArray(e) && 2 === e.length && c(e[0]) && c(e[1]) && new Date(e[1]).getTime() >= new Date(e[0]).getTime()) : c(this.currentValue)) && this.updateDate(!0), this.emitDate("confirm"), this.closePopup();
        },
        ...
        handleFocus: function handleFocus(e) {
          this.popupVisible || this.showPopup(), this.$emit("focus", e);
        },
        handleKeydown: function handleKeydown(e) {
          var t = e.keyCode;
          9 !== t && 13 !== t || (e.stopPropagation(), this.handleChange(), this.userInput = null, this.closePopup());
        },
    ...
    }, "undefined" != typeof window && window.Vue && P.install(window.Vue);
    t["default"] = P;
  }, function (e, t) {
    e.exports = function () {
      var e = [];
