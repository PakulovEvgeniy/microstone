...
class Brands extends Model
{
    ...
    public static function getBrandsCategory($id) {
      ...
      $type_pr = $type_pr->id;
      $rows = PartyParams::where(['party_params.param_type_id' => $type_pr, 'party_params.value_id' => $id])
        ...
        ->leftJoin('products','products.id_1s','=','party_params.product_id1s')
        ->leftJoin('category as cat1','cat1.id_1s','=','products.parent_id')
        ->leftJoin('category_description as cat_d1','cat_d1.id','=','cat1.id')
        ->leftJoin('category as cat2','cat2.id_1s','=','cat1.parent_id')
        ->leftJoin('category_description as cat_d2','cat_d2.id','=','cat2.id')
